...
static func build_default_moves() -> Array[MoveDefinition]:
	var moves: Array[MoveDefinition] = [
		...
		_make("632146K", "Super Kick", MoveDefinition.MoveType.SUPER, "632146", "K", 14, 12, 36, 390, "anim_overdrive", "super_flash", "super", 4.2, 1.35, MoveDefinition.AttackLevel.MID, 200, true, 70),
	...
	for move in moves:
		if move.id in ["236236J", "632146K", "236236O"]:
			move.cinematic_enabled = true
			move.cinematic_duration_frames = 620
